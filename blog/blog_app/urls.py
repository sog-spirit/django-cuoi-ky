...
urlpatterns = [
    ...
    path('edit-comment/<slug:slug>/<int:pk>/', views.edit_comment, name='edit_comment'),
    path('delete-comment/<slug:slug>/<int:pk>/', views.delete_comment, name='delete_comment'),
    path('search-post/', views.SearchedList.as_view(), name='search_post'),
]